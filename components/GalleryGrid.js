...
export default function GalleryGrid({ images }) {
  ...
  return (
    <>
        ...
        {images.map((img, index) => (
          <li key={`${img.src}-${index}`}>
            <button
              ...
              className="group relative block aspect-[4/3] w-full overflow-hidden rounded-2xl border-0 bg-surface-muted p-0"
      ...
      {isOpen && active && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(34,31,26,0.88)] p-4"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          >
            ...
            <div className="relative h-[min(72vh,640px)] w-full overflow-hidden rounded-2xl bg-black">
              <Image
                src={active.src}
                alt={active.alt}
                fill
