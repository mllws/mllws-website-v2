const SITE_URL = "https://www.motherlanguagelovers.com";
const IMG = "";
...
export const nav = [
  ...
  { label: "About Us", href: "/about", translated: "قصتنمن نحن" }
];
...
export const sponsors = [
  { name: "City of Surrey", src: `${IMG}/sponsors/surrey_mod.png` },
  { name: "Surrey Libraries", src: `${IMG}/sponsors/surreyLib.jpg` },
  { name: "Surrey Schools", src: `${IMG}/sponsors/surrey_school.png` },
  { name: "Vancouver School Board", src: `${IMG}/sponsors/vancouver_school.png` },
  { name: "Richmond School District 38", src: `${IMG}/sponsors/richmond_school.png` },
  { name: "Langley Schools", src: `${IMG}/sponsors/langley-schools.png` },
  { name: "Ottawa Catholic School Board", src: `${IMG}/sponsors/ottawa_catholic_school.png` },
];

export const heroSlides = [
  {
    image: `${IMG}/banners/Vancouver.jpg`,
    alt: "Vancouver skyline — home of International Mother Language Day advocacy",
  },
  {
    image: `${IMG}/banners/MotherLanguageDay.png`,
    alt: "International Mother Language Day celebration",
  },
  {
    image: `${IMG}/banners/mllws2.jpg`,
    alt: "Mother Language Lovers of the World Society community gathering",
  },
  {
    image: `${IMG}/banners/mllws4.png`,
    alt: "MLLWS festival moment",
  },
  {
    image: `${IMG}/banners/mllws3.png`,
...
export const galleryImages = [
  { src: `${IMG}/banners/mllws2.jpg`, alt: "Community Gathering at an MLLWS Event", span: true },
  { src: `${IMG}/banners/MotherLanguageDay.png`, alt: "International Mother Language Day" },
  { src: `${IMG}/banners/mllws3.png`, alt: "Festival Performance" },
  { src: `${IMG}/banners/mllws4.png`, alt: "Festival Attendees" },
  { src: `${IMG}/banners/Vancouver.jpg`, alt: "Vancouver — Home of IMLD Advocacy" },
];

// Homepage mosaic fallback until a Payload gallery snapshot exists.
...
export const upcomingEvent = {
  ...
  image: `${IMG}/upcoming_events/MLF_2026.jpg`,
...
export const membershipTiers = [
  {
    ...
    subtitle: "Free / Volunteer",
    price: "$0",
    period: "/year",
    featured: false,
    perks: [
      "Receive MLLWS updates and announcements.",
      "Volunteer at MLLWS events and initiatives.",
      "Connect with the MLLWS community.",
      "Non-voting membership with opportunities to contribute.",
    ],
    cta: "Join Us",
  },
  {
    name: "General Member",
    subtitle: "Annual Voting Member",
    price: "$20",
    period: "/ year",
    featured: true,
    perks: [
      "Full voting rights at general meetings",
      "Eligibility to participate in organizational decisions",
      "Opportunities to join sub-committees",
    ],
    cta: "Join Us",
  },
  {
    ...
    featured: false,
    perks: [
      "Earned after 3 consecutive years of active membership.",
      "Lifetime voting rights.",
      "Recognition as a sustaining pillar of MLLWS.",
      "Permanent membership with no annual renewal.",
    ],
    cta: "Learn More",
  },
  {
    name: "Honorary Member",
    subtitle: "By Invitation / Recognition",
    price: "Waived",
    period: "",
    featured: false,
    perks: [
      "Recognition for exceptional service.",
      "Honorary connection with MLLWS.",
      "Participation in selected events and initiatives.",
...
export const directors = [
  {
    name: "Hafizul Islam",
    title: "President & CEO",
    photo: `${IMG}/directors/svp.jpg`,
    email: "mhislam@mllws.com",
  },
  {
    name: "To Be Announced",
    title: "Senior Vice President",
    photo: `${IMG}/directors/Avatar_1.jpg`,
    email: "contact@mllws.com",
  },
  {
    name: "Sarker M Arefin",
    title: "Vice President",
    photo: `${IMG}/directors/vp.jpg`,
    email: "smarefin@mllws.com",
  },
  {
    name: "Mohammad M Islam",
    title: "Secretary General",
    photo: `${IMG}/directors/ICT.jpg`,
    email: "admin@mllws.com",
  },
  {
    name: "Mohammad Emon",
    title: "Director Global Language Heritage & Monuments",
    photo: `${IMG}/directors/Heritage_Monuments.jpg`,
    email: "contact@mllws.com",
  },
  {
    name: "Fahad H Chowdhury",
    title: "Director Finance",
    photo: `${IMG}/directors/Finance.jpg`,
    email: "finance@mllws.com",
  },
  {
    name: "Saamiya S Rin",
    title: "Director Multicultural Event Celebration",
    photo: `${IMG}/directors/Event_Celebration.jpg`,
    email: "contact@mllws.com",
  },
  {
    name: "To Be Announced",
  ...
  },
  {
    ...
    photo: `${IMG}/directors/Implementation_Windsor.jpg`,
    email: "sbhuiyan@mllws.com",
  },
  {
    name: "Shah Bahauddin",
    title: "Director Implementation of IMLD - Ottawa",
    photo: `${IMG}/directors/Implementation_Ottawa.jpg`,
    email: "sbahauddin@mllws.com",
  },
  {
    name: "Khair Khandaker",
    title: "Director Implementation of IMLD - Calgary",
    photo: `${IMG}/directors/Implementation_Calgary.jpg`,
    email: "kkhandaker@mllws.com",
  }
];
...
export const chapters = [
  {
    ...
    photo: `${IMG}/directors/US_Chapter_President.jpg`,
    email: "marshallh@mllws.com",
  },
  {
    name: "Shehzaad Shams",
    title: "President, UK Chapter",
    photo: `${IMG}/directors/UK_Chapter_President.jpg`,
    email: "sshams@mllws.com",
  },
];
...
export const advisors = [
  {
    ...
    title: "Chief Advisor",
    photo: `${IMG}/directors/President.jpg`,
    email: "maislam@mllws.com",
  },
  {
    name: "Mizan Majumder",
    title: "Advisor",
  ...
  },
  {
    ...
    title: "Advisor",
    photo: `${IMG}/directors/Advisor_3.jpg`,
    email: "ssajjadrahman@gmail.com",
  },
  {
    name: "Hasan Ferdous",
    title: "Advisor",
    photo: `${IMG}/directors/Advisor_2.jpg`,
...
export const recommendationLetters = [
  {
    ...
    pdf: "/docs/recomendations/Surrey_School_District_IMLD_Recognition.pdf",
  },
  {
    title: "Letter of Support - Surrey Public Libraries",
    pdf: "/docs/recomendations/Support_letter_Surrey_Public_Libraries.pdf",
  },
  {
    title: "Letter of Support - Heritage Canada",
    pdf: "/docs/recomendations/Heritage_Canada_MLF_celebration.pdf",
  },
  {
    title: "Letter of Recognition - Langley Board of Education",
    pdf: "/docs/recomendations/Langley_Board_of_Education_IMLD_Recognition.pdf",
  },
  {
    title: "Letter of Recognition - Richmond School District",
    pdf: "/docs/recomendations/Richmond_School_District_IMLD_Recognition.pdf",
  },
  {
    title: "Letter of Recognition - Vancouver Board of Education",
    pdf: "/docs/recomendations/Vancouver_Board_of_Education_IMLD_Recognition.pdf",
  },
];

export const siteLogo = "/Logo-Without-MLLWS-Solid-Center.png";
...
export const contactInfo = {
  ...
  locationLabel: "Surrey, BC, Canada",
  social: [
...
export const organizationSchema = {
  ...
  url: SITE_URL,
  logo: siteLogoFull,
  name: "Mother Language Lovers of the World Society",
  legalName: "Mother Language Lovers of the World Society",
  description:
    "A non-profit organization that brings together diverse linguistic and cultural communities to celebrate heritage, promote multiculturalism, and support intercultural harmony.",
  sameAs: contactInfo.social.map(({ href }) => href),
  email: contactInfo.email,
  telephone: contactInfo.phone,
  address: {
    "@type": "PostalAddress",
    streetAddress: contactInfo.address[0],
    addressLocality: "Surrey",
    addressRegion: "BC",
    postalCode: contactInfo.address[2],
    addressCountry: "CA",
  },
};
